...
<tr id="<?=$this->GetEditAreaId($arItem['ID']);?>">
	...
	<td valign="top">
		...
		<?if($arParams["DISPLAY_NAME"]!="N" && $arItem["NAME"]):?>
			<?if(!$arParams["HIDE_LINK_WHEN_NO_DETAIL"] || ($arItem["DETAIL_TEXT"] && $arResult["USER_HAVE_ACCESS"])):?>
				<?if(!empty($arItem['DISPLAY_PROPERTIES']['GROUP']['VALUE'])):?>
					<div class="group">
						<a href="#" class="js-open"><?=$arItem['~NAME'];?></a>
						<div class="group-body">
							<?foreach ($arItem['DISPLAY_PROPERTIES']['GROUP']['LINK_ELEMENT_VALUE'] as $idLink => $link):?>
