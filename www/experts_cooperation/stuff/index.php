...
$APPLICATION->SetTitle("Состав");
$APPLICATION->SetPageProperty("h2", "Состав");
...
$parts = CIBlockSection::GetList(array('SORT'=>'ASC'),array('ACTIVE'=>'Y','IBLOCK_ID'=>Config::IBLOCK_DOCTORS));
$sParts = array(
	"reference" => array(),
	"reference_id" =>array()
);
